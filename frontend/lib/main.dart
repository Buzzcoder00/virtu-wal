...
void main() async {
  ...
  runApp(const VirtuWalApp());
}

class VirtuWalApp extends StatelessWidget {
...
class VirtuWalShell extends StatelessWidget {
  const VirtuWalShell({super.key});
    ...
    switch (state.currentView) {
      ...
      case 'active':
        ...
        return qr == null
            ...
            : ActiveQrScreen(state: state, qrData: qr);
      case 'history':
          ...
          Container(
            ...
            child: IconButton(
              ...
              icon: Icon(
                ...
                color:
                    isDark ? const Color(0xFFFACC15) : const Color(0xFF6366F1),
              ),
            ),
          ),
        ],
